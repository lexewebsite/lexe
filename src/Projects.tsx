...
function Projects() {
  return <div class="w-full text-center"> 
    <h1 class="text-7xl text-center m-12 w-full">Projects</h1>
    <h1 class="text-5xl text-center w-full m-12">Focus Areas</h1> 
    <div class="w-[90%] ml-[5%] flex-col flex gap-8"> 
      <FocusArea name={"STEM"} description={technologyParagraphs_FA} imageSrcs={[labquest]} altTexts={["An image of a stack of calculators purchased with a grant from Lynbrook Excellence in Education Foundation."]} captions={[null]}/>
      <FocusArea name={"Arts & Humanities"} description={ah_FA} imageSrcs={[band, mgenesis]} altTexts={["A photograph of Lynbrook students playing in a band with instruments.", "A photograph of Lynbrook Students using some musical application on computer desktops."]} captions={["Harps", "Music Genesis Class"]}/>
