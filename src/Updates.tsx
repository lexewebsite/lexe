    ...
    <div class="container px-4 py-12 flex flex-col items-center gap-2 text-base-content">
      ...
      <div class="container flex flex-col gap-2 max-w-4xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 mt-1">
          <a class="btn btn-accent text-lg font-normal" href="https://app.flashissue.com/newsletters/44bf3813e1bc67cb1bbee671c9d7f517b05e9c51">2020</a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 mt-1">
          <a class="btn btn-accent text-lg font-normal" href={report2020}>2020</a>
        </div>
      </div>
    </div>
  )
